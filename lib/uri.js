...
/**
 * Internal function to transform a RVN string amount into satoshis
 *
 * @param {string} amount - Amount RVN string
 * @throws {TypeError} Invalid amount
...
URI.prototype._parseAmount = function(amount) {
  ...
  return Unit.fromRVN(amount).toSatoshis();
};
...
URI.prototype.toString = function() {
  var query = {};
  if (this.amount) {
    query.amount = Unit.fromSatoshis(this.amount).toRVN();
  }
  if (this.message) {
